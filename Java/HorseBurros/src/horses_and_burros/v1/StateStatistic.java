...
public class StateStatistic extends Statistic implements Serializable {
	 ...
	 * The Serialize
	 */
	private static final long serialVersionUID = 1795984998730939949L;
	
	/** Basic file name for all StateStatistics
	 * 	   The first is the before-part of the fileName
	 * 	   The second is the after-part of the fileName
	 * */
	private static final String FILE_NAME = "C://temp/stateStat.ser";
	...
	public static StateStatistic deserialize(){
		// StateStatistic newStateStat = new StateStatistic
		FileInputStream fileIn = null;
		ObjectInputStream in = null;
		StateStatistic newStateStat;
		
		System.out.print("\nDeserializing state ");
		try {
			fileIn = new FileInputStream(FILE_NAME);
			in = new ObjectInputStream(fileIn);
			newStateStat = (StateStatistic) in.readObject();
			in.close();
			fileIn.close();
			System.out.print(newStateStat.getState());
			return newStateStat;
		}
		catch (Exception e) {
